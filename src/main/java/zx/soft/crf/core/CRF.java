...
public class CRF implements Serializable {
	 ...
	 * described in
	 * @see zx.soft.crf.core.CrfParams
	 */
	...
	public Viterbi getViterbi(int beamsize) {
		return params.miscOptions.getProperty("segmentViterbi", "false").equals("true") ? new SegmentViterbi(this,
				beamsize) : new Viterbi(this, beamsize);
	}
