...
public class NestedModel extends Model {
	...
	@Override
	public int firstStartStateId(int label) {
		return nodeOffsets[label] + inner[label].startState(0);
	}

	@Override
	public int lastEndStateId(int label) {
		return nodeOffsets[label] + inner[label].endState(inner[label].numEndStates() - 1);
	}
