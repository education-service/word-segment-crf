...
public class DataCruncherReadRowFixedColTest {
	...
	public void testReadRowFixedCol() {
		...
		try {
			...
			int ptr = DataCruncher.readRowFixedCol(numLabels, reader, tagDelimit, delimit, impDelimit, t, cArray,
					labels);
			assertEquals(ptr, 4);
	...
	public void testReadRowFixedColSecond() {
		...
		try {
			...
			ptr = DataCruncher.readRowFixedCol(numLabels, reader, tagDelimit, delimit, impDelimit, t, cArray, labels);
			assertEquals(ptr, 4);
